    ...
    return (
        <div>
            <Row>
                ...
                <Col lg={4}>
                    <h2 className="mt-3" style={{ color: '#Ca3e47' }}>Hae elokuvaa</h2>
                    <p className="text-muted" style={{fontSize:'15px'}}>Etsi elokuvan nimellä tai valitse genre ja  esitysjärjestys</p>
                    <input className="mb-2 w-75 rounded " type="search" placeholder="Hae elokuvia..." onChange={(e) => setSearchInput(e.target.value)} />
                </Col>
                <Col>
                    ...
                    <Dropdown>
                        ...
                        <Dropdown.Menu>
                            ...
                            <Dropdown.Item onClick={() => handleSetSortBy('', '')}>Tyhjennä valinta</Dropdown.Item>
                            <Dropdown.Item onClick={() => handleSetSortBy('popularity.desc', 'Suosituimman mukaan')}>Suosituimman mukaan</Dropdown.Item>
                            <Dropdown.Item onClick={() => handleSetSortBy('release.asc', 'Vanhimman mukaan')}>Vanhimman mukaan</Dropdown.Item>
                            <Dropdown.Item onClick={() => handleSetSortBy('release_date.desc', 'Uusiman mukaan')}>Uusiman mukaan</Dropdown.Item>
                            <Dropdown.Item onClick={() => handleSetSortBy('vote_average.desc', 'Korkein arvosana')}>Korkein arvosana</Dropdown.Item>
                            <Dropdown.Item onClick={() => handleSetSortBy('vote_average.asc', 'Matalin arvosana')}>Matalin arvosana</Dropdown.Item>
                        </Dropdown.Menu>
                    </Dropdown>
                </Col>
            </Row>
