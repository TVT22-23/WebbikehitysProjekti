...
module.exports = {addAccount, getAccount, checkUser, deleteAccount, updateAccount, updateLayout, getAccountNameById};       //exporting functions to be used in Route-files - included in every postgre file